...
$string['consumerkey_desc'] = 'A unique key that has been provided to you by ClickView and identifies your platform. If you do not provide a valid key, users will not be able to sign into the plugin.';
...
$string['eventsapi'] = 'Events API';
$string['eventsapi_desc'] = 'The CVEvents API is a lightweight JavaScript tool (1.3KB) allows you to communicate with the IFrame containing the ClickView plugin.';
$string['shareplayembedurl'] = 'Share Play Embed URL';
$string['shareplayembedurl_desc'] = 'Will be extended automatically with the following parameters: consumerKey, shareCode, a (a = autoplay).';
$string['iframeurl'] = 'IFrame URL';
$string['iframeurl_desc'] = 'Will be extended automatically with the following parameters: consumerKey, schoolId.';
